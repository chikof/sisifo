...
<div class="sites">
  ...
  {:else if sites.length === 0}
    <div class="empty-state">
      <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" style="color: var(--text-3)"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
      ...
      {#each sites as site (site.hash)}
        <div class="site-card">
          <div class="site-main">
            ...
            <div class="site-meta">
              <span>{site.file_count} file{site.file_count !== 1 ? 's' : ''}</span>
              <span class="sep">·</span>
            ...
            <div class="hash-row">
              ...
              <button class="copy-btn" on:click={() => copy(site.hash)} title="Copy full address">
                {#if copied === site.hash}
...
<style>
  ...
  .site-card:hover { border-color: #c8c4be; }

  .site-main { display: flex; flex-direction: column; gap: 5px; min-width: 0; }
  ...
  .unpin-btn:hover:not(:disabled) { border-color: #f87171; color: #ef4444; background: #fef2f2; }
  .unpin-btn:disabled { opacity: 0.5; cursor: default; }
